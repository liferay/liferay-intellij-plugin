...
public class LiferayJSPredefinedLibraryProviderTest extends LightJavaCodeInsightFixtureTestCase {
	...
	public void setUp() throws Exception {
		...
		Class<LiferayJSPredefinedLibraryProvider> clazz = LiferayJSPredefinedLibraryProvider.class;

		FieldUtils.writeDeclaredStaticField(clazz, "_targetPlatformArtifacts", targetPlatformArtifacts, true);
