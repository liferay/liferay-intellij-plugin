...
public class ComponentPropertiesCompletionContributor extends CompletionContributor {
	...
	static {
		_componentProperties.put(
			...
			new String[][] {
				{"javax.portlet.description", "String"}, {"javax.portlet.name", "String"},
				{"javax.portlet.display-name", "String"}, {"javax.portlet.init-param", ""},
				{"javax.portlet.expiration-cache", "int"}, {"javax.portlet.mime-type", "String"},
				{"javax.portlet.portlet-mode", "String"}, {"javax.portlet.window-state", "String"},
				{"javax.portlet.resource-bundle", "String"}, {"javax.portlet.info.title", "String"},
				{"javax.portlet.info.short-title", "String"}, {"javax.portlet.info.keywords", "String"},
				{"javax.portlet.preferences", "String"}, {"javax.portlet.security-role-ref", "String"},
				{"javax.portlet.supported-processing-event", "String"},
				{"javax.portlet.supported-publishing-event", "String"},
				{"javax.portlet.supported-public-render-parameter", "String"}, {"com.liferay.portlet.icon", "String"},
				{"com.liferay.portlet.virtual-path", "String"}, {"com.liferay.portlet.struts-path", "String"},
				...
				{"com.liferay.portlet.pop-up-print", "boolean"}, {"com.liferay.portlet.layout-cacheable", "boolean"},
				{"com.liferay.portlet.instanceable", "boolean"}, {"com.liferay.portlet.remoteable", "boolean"},
				...
				{"com.liferay.portlet.action-timeout", "int"}, {"com.liferay.portlet.render-timeout", "int"},
				{"com.liferay.portlet.render-weight", "int"}, {"com.liferay.portlet.ajaxable", "boolean"},
				...
				{"com.liferay.portlet.add-default-resource", "boolean"}, {"com.liferay.portlet.system", "boolean"},
				{"com.liferay.portlet.active", "boolean"}, {"com.liferay.portlet.display-category", "String"}
			});
		...
		_componentProperties.put(
			...
			new String[][] {{"javax.portlet.name", "String"}, {"com.liferay.portlet.friendly-url-routes", "String"}});
		...
		_componentProperties.put(
			...
			new String[][] {
				{"javax.portlet.name", "String"}, {"editor.config.key", "String"}, {"editor.name", "String"},
		...
		_componentProperties.put(
			...
			new String[][] {{"panel.category.key", "String"}, {"panel.app.order", "Integer"}, });
		...
		_componentProperties.put(
			...
			new String[][] {
				{"preinitialized.filter", "boolean"}, {"service.id", "String"}, {"javax.portlet.name", "String"}
			});
		...
		_componentProperties.put(
			...
			new String[][] {
				...
				{"servlet-context-name", "String"}, {"servlet-filter-name", "String"}, {"url-pattern", "String"},
				{"init.param", "String"}
			});
