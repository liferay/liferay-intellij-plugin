	...
	static {
		_taglibAttributes.put(
			...
			Arrays.asList(
				...
				new SimpleImmutableEntry<>("alert", "cssClass"), new SimpleImmutableEntry<>("button", "cssClass"),
				new SimpleImmutableEntry<>("button-row", "cssClass"), new SimpleImmutableEntry<>("col", "cssClass"),
				new SimpleImmutableEntry<>("container", "cssClass"),
				new SimpleImmutableEntry<>("field-wrapper", "cssClass"),
				new SimpleImmutableEntry<>("fieldset", "cssClass"), new SimpleImmutableEntry<>("form", "cssClass"),
				new SimpleImmutableEntry<>("icon", "cssClass"), new SimpleImmutableEntry<>("input", "cssClass"),
				new SimpleImmutableEntry<>("input", "helpTextCssClass"),
				new SimpleImmutableEntry<>("input", "wrapperCssClass"), new SimpleImmutableEntry<>("nav", "cssClass"),
		...
		_taglibAttributes.put(
			...
			Arrays.asList(
				...
				new SimpleImmutableEntry<>("header", "cssClass"), new SimpleImmutableEntry<>("icon", "cssClass"),
				new SimpleImmutableEntry<>("icon", "iconCssClass"), new SimpleImmutableEntry<>("icon", "linkCssClass"),
				...
				new SimpleImmutableEntry<>("my-sites", "cssClass"), new SimpleImmutableEntry<>("panel", "cssClass"),
