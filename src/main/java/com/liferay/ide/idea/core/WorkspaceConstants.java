...
public class WorkspaceConstants {
	...
	public static final String DEFAULT_TARGET_PLATFORM_VERSION = "7.4.3.16";
	...
	public static final Map<String, String[]> targetPlatformVersionMap = new HashMap<String, String[]>() {
		{
			...
			put(
				"7.4",
				new String[] {
					"7.4.3.52", "7.4.3.51", "7.4.3.50", "7.4.3.49", "7.4.3.48", "7.4.3.47", "7.4.3.46", "7.4.3.45",
					"7.4.3.44", "7.4.3.43", "7.4.3.42", "7.4.3.41", "7.4.3.40", "7.4.3.39", "7.4.3.38", "7.4.3.37",
					"7.4.3.36", "7.4.3.35", "7.4.3.34", "7.4.3.32", "7.4.3.31", "7.4.3.30", "7.4.3.29", "7.4.3.28",
					"7.4.3.27", "7.4.3.26", "7.4.3.25", "7.4.3.24", "7.4.3.23", "7.4.3.22", "7.4.3.21", "7.4.3.20",
					"7.4.3.19", "7.4.3.18", "7.4.3.17", "7.4.3.16", "7.4.3.15", "7.4.3.14", "7.4.3.13", "7.4.3.12",
					"7.4.3.11", "7.4.3.10", "7.4.3.9", "7.4.3.8", "7.4.3.7", "7.4.3.6", "7.4.3.5", "7.4.3.4", "7.4.2-1",
					"7.4.1-1", "7.4.0"
				});
		}
	};
