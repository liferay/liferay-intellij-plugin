...
public class WorkspaceConstants {
	...
	public static final String DEFAULT_TARGET_PLATFORM_VERSION = "7.4.3.61";
	...
	public static final Map<String, String> liferayBundleUrlVersions = new HashMap<String, String>() {
		{
			...
			put(
				"7.4.3.73",
				LIFERAY_PORTAL_URL + "7.4.3.73-ga73/liferay-ce-portal-tomcat-7.4.3.73-ga73-20230419090137163.tar.gz");
		}
	};
	public static final Map<String, String[]> targetPlatformVersionMap = new HashMap<String, String[]>() {
		{
			...
			put(
				"7.4",
				new String[] {
					"7.4.3.73", "7.4.3.72", "7.4.3.71", "7.4.3.70", "7.4.3.69", "7.4.3.68", "7.4.3.67", "7.4.3.66",
					"7.4.3.65", "7.4.3.64", "7.4.3.63", "7.4.3.62", "7.4.3.61", "7.4.3.60", "7.4.3.59", "7.4.3.58",
					"7.4.3.57", "7.4.3.56", "7.4.3.55", "7.4.3.54", "7.4.3.53", "7.4.3.52", "7.4.3.51", "7.4.3.50",
					"7.4.3.49", "7.4.3.48", "7.4.3.47", "7.4.3.46", "7.4.3.45", "7.4.3.44", "7.4.3.43", "7.4.3.42",
					"7.4.3.41", "7.4.3.40", "7.4.3.39", "7.4.3.38", "7.4.3.37", "7.4.3.36", "7.4.3.35", "7.4.3.34",
